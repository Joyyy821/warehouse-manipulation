...
calibration_points.append(Point(0.18, -0.05,  calibration_points_z))
calibration_points.append(Point(0.18, -0.1,  calibration_points_z))
calibration_points.append(Point(0.22, 0.05,     calibration_points_z))
calibration_points.append(Point(0.22, 0,     calibration_points_z))
calibration_points.append(Point(0.22, -0.05,     calibration_points_z))
calibration_points.append(Point(0.22, -0.1,     calibration_points_z))
calibration_points.append(Point(0.25, -0.1, calibration_points_z))
